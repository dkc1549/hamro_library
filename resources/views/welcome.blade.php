    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Welcome to the HAMRO LIBRARY') }}
            </h2>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-12 space-y-6">
            <div class="p-6 sm:p-10 lg:p-12 bg-white shadow sm:rounded-lg">
                ...
                <div class="flex justify-center items-center h-24 bg-gray-100 rounded shadow-sm">
                    <h1 class="text-2xl font-semibold">Welcome to our HAMRO LIBRARY</h1>
                </div>

                <!-- About Section -->
                <div class="mt-6">
                    <p>"The HAMRO LIBRARY is not just another digital platform—it's a gateway to a universe of knowledge, available at the fingertips of every individual. Our vast and eclectic collection spans across books, magazines, and various other enriching materials tailored to cater to diverse reading appetites.
